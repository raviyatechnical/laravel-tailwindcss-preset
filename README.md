...
2. Install this preset via `composer require raviyatechnical/tailwindcss --dev`. Laravel will automatically discover this package. No need to register the service provider.
